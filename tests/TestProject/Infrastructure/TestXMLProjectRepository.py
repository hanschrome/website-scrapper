...
class TestXMLProjectRepository(unittest.TestCase):
    def test_create(self):
        ...
        self.assertTrue(os.path.exists("My Project"))
        self.assertTrue(os.path.exists(os.path.join("My Project", "project.xml")))

        # Check the contents of the XML file
        tree = ET.parse(os.path.join("My Project", "project.xml"))
        root = tree.getroot()
